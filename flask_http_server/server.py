...
def start_slave():
    ...
    result = subprocess.run(['ansible-playbook', slave_start_playbook, '--extra-vars', '"aws_access_key=' + aws_access_key + ' ' + 'aws_secret_key=' + aws_secret_key + '"'], stdout=PIPE, stderr=PIPE)
